export const charter = {
  ...
  intro:
    "Cette charte s'applique à **toute photo et tout texte** publiés sur PetMatch. " +
    "Elle est acceptée en même temps que le règlement, et elle engage : une publication " +
    "qui ne la respecte pas est retirée, et le compte qui l'a déposée peut être suspendu.",
  sections: [
    {
      title: '1. Ce que PetMatch met en valeur',
      blocks: [
        { type: 'p', text:
          "PetMatch met en valeur **l'animal tel qu'il est** : son allure, son caractère, " +
          "et l'instant que son humain a su saisir. Un concours y est une célébration, " +
          "jamais une épreuve imposée à l'animal." },
        { type: 'p', text:
          "Toute photo doit avoir été prise dans des conditions où l'animal était **libre " +
          "de ses mouvements, en bonne santé apparente et non contraint**." },
      ],
    },
    {
      title: "2. Ce qui n'est pas publiable",
      blocks: [
        { type: 'p', text: 'Sont refusés, et retirés sans préavis :' },
        { type: 'li', text:
          "**La souffrance, la contrainte ou la peur** : animal entravé, maintenu de force, " +
          "muselé hors nécessité vétérinaire, en détresse visible, ou placé dans une " +
        ...
        { type: 'li', text:
          "**Les contenus violents, sexuels, haineux, discriminatoires** ou faisant la " +
          "promotion d'activités illégales, y compris les combats d'animaux et le trafic." },
        { type: 'li', text:
          "**Les photos qui ne sont pas de vous** : images trouvées en ligne, achetées, " +
          "générées par une intelligence artificielle, ou représentant l'animal d'un tiers " +
          "sans son accord." },
        { type: 'li', text:
          "**Les personnes identifiables** sans leur accord, et **tout mineur reconnaissable** " +
          "même avec l'accord de ses parents." },
        { type: 'li', text:
          "**Les données personnelles visibles** : plaque d'immatriculation, adresse, " +
          "document d'identité, numéro de téléphone." },
      ],
    },
    {
      title: '3. Authenticité',
      blocks: [
        { type: 'p', text:
          ...
          "sont pas." },
        { type: 'p', text:
          "PetMatch procède à un **contrôle de cohérence** entre les photos d'un même animal " +
          "au fil des concours. Une incohérence manifeste entraîne le retrait de la " +
          "participation et, le cas échéant, l'annulation des résultats obtenus." },
      ],
    },
    {
      title: '4. Le rôle de juré',
      blocks: [
        { type: 'p', text:
        ...
        { type: 'p', text:
          ...
          "acquis et la suspension du compte." },
      ],
    },
    {
      ...
      blocks: [
        ...
        { type: 'p', text:
          ...
          "d'identité, suspension temporaire, fermeture définitive du compte. Les " +
          "maltraitances caractérisées sont signalées aux autorités compétentes." },
        { type: 'p', text:
          "Toute décision peut être contestée en répondant au message qui l'annonce. Le " +
          "réexamen est fait par une personne différente de celle qui a décidé." },
      ],
    },
    {
