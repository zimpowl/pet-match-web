  ...
  <>
    ...
    <main className="flex-1 w-full max-w-7xl px-6 py-12 flex flex-col items-center text-center z-10">
      ...
      <div className="flex flex-col sm:flex-row gap-6 mb-24 w-full justify-center items-center">
        ...
        >
          ...
          <div className="text-left">
            <p className="text-[10px] uppercase font-black opacity-60 tracking-widest">Disponible sur</p>
            <p className="text-xl font-black">Google Play</p>
          </div>
        </a>
        {/* App Store - Coming Soon */}
        <div className="flex items-center gap-5 bg-surface-container-high text-secondary/50 px-10 py-5 rounded-[2rem] border-2 border-dashed border-outline/20">
          <div className="text-3xl grayscale opacity-30">🍎</div>
          <div className="text-left">
            <p className="text-[10px] uppercase font-black opacity-60 tracking-widest">Bientôt sur l'</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-6 w-full max-w-5xl px-4 py-8 relative">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-32 bg-primary/5 blur-[100px] -z-10"></div>
    ...
    <div className="min-h-screen relative flex flex-col items-center overflow-x-hidden">
      ...
      <footer className="w-full py-12 text-center z-10">
        <div className="flex justify-center gap-10 mb-6">
          <Link to="/privacy"
                className="text-xs font-black uppercase tracking-widest text-primary hover:opacity-50 transition">Confidentialité</Link>
          <Link to="/assistance"
                className="text-xs font-black uppercase tracking-widest text-primary hover:opacity-50 transition">Assistance</Link>
        </div>
        <p className="text-[10px] font-bold text-outline uppercase tracking-[0.2em]">© 2026 PetMatch — Tous droits réservés</p>
      </footer>
    </div>
  );
};
